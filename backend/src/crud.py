...
from src.schemas import CreateProduct, CreateProductCategory, CreatePersonalCategory, CreateLaboratory, \
    ...
    CreatePersonalLaboratory, PersonalCategory, ProductCategory, TestLaboratories, UpdateBrigades, \
    UpdateEngineerPersonal, UpdatePersonalLaboratory, UpdatePersonalWorkers, UpdateProduct, UpdateTool, \
